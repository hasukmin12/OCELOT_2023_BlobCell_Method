...
class PytorchUnetCellModel():
    ...
    def __init__(self, metadata):
        ...
        _path_to_checkpoint = os.path.join(_curr_path, "/vast/AI_team/sukmin/Results_monai_Lunit_Challenge_for_paper/Cell_r14_3_concat_StainNorm_with_one_blobcell_No_MONAI/model_e26250_dice0.7774542685894519.pth")
        ...
        self.t_model.eval()                                                                                                                                           # class_model_best_e15750_dice0.7377268075942993.pth
                                                                                                                                                                      # class_model_best_e24500_dice0.7393077611923218.pth
        _path_to_checkpoint = os.path.join(_curr_path, '/vast/AI_team/sukmin/Results_monai_Lunit_Challenge_for_paper/Cell_Only_StainNorm_BlobCell_One_class_No_MONAI/class_model_best_e24500_dice0.7393077611923218.pth')
        state_dict = torch.load(_path_to_checkpoint, map_location=torch.device('cuda:0'))
