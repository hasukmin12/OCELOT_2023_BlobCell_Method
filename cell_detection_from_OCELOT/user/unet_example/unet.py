...
class PytorchUnetCellModel():
    ...
    def load_checkpoint(self):
        ...
        # _path_to_checkpoint = os.path.join(_curr_path, "/vast/AI_team/sukmin/checkpoints/model_e08500.pth")
        _path_to_checkpoint = "/vast/AI_team/sukmin/Results_monai_Lunit_Challenge/Lunit_Cell_only_Lunit_UNet_not_norm_b4_rad12/model_e14000.pth" # model_e14000.pth  # model_best_13200.pth
        state_dict = torch.load(_path_to_checkpoint, map_location=torch.device('cpu'))
        # check_pont = torch.load(_path_to_checkpoint)
