...
save_name = 'Cell_Only_StainNorm_BlobCell_One_class_No_MONAI'
...
info = {
    ...
    "CHANNEL_IN"    : 3,
    "CHANNEL_OUT"   : 2,
    "CLASS_NAMES"   : {1:'BlobCell'}, # 0: "white space"
    "NUM_CLASS"     : 1,  
...
config = {
    ...
    # s * 8 = 2800 * 150
    # 35000 * 8 = 2800 * e
    "MAX_ITERATIONS": 30000, #    42000 (= 8batch, 120 epochs)       52500 (= 8batch, 150 epochs)         70000 (= 8batch, 200 epochs)          
