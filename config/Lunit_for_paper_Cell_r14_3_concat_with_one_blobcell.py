...
save_name = 'Cell_r14_3_concat_StainNorm_with_one_blobcell_No_MONAI'
...
config = {
    ...
    # s * 8 = 2800 * 150
    # 35000 * 8 = 2800 * e
    "MAX_ITERATIONS": 42000, # 42000,    42000 (= 8batch, 120 epochs)       52500 (= 8batch, 150 epochs)         70000 (= 8batch, 200 epochs)          
