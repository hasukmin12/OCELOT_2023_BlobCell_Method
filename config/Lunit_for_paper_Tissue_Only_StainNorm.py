...
save_name = 'Tissue_Only_StainNorm_No_MONAI'
...
info = {
    ...
    "CHANNEL_IN"    : 3,
    "CHANNEL_OUT"   : 4,
    "CLASS_NAMES"   : {1:'BackGround', 2:'Tumor Area', 3:'Others'}, # {1:'Tumor Area', 2:'Others'}, # 0: "white space"
    "NUM_CLASS"     : 3,  
...
config = {
    ...
    # s * 8 = 2800 * 150
    # 35000 * 8 = 2800 * e
    "MAX_ITERATIONS": 20000, # 42000, #    42000 (= 8batch, 120 epochs)       52500 (= 8batch, 150 epochs)         70000 (= 8batch, 200 epochs)          
