...
from .segmentation_model_for_tissue import SegmentationModel_for_tissue_DeepSupervision



class DeepLabV3Plus_for_tissue_DeepSupervision_b(SegmentationModel_for_tissue_DeepSupervision):
