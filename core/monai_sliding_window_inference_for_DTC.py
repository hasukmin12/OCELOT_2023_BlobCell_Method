...
__all__ = ["sliding_window_inference_for_tanh"]


def sliding_window_inference_for_tanh(
    inputs: torch.Tensor,
    ...
    **kwargs: Any,
    ...
    for slice_g in tqdm(range(0, total_slices, sw_batch_size)) if progress else range(0, total_slices, sw_batch_size):
        ...
        # 여기서 segout, tanh 인지 결정해야한다.
        seg_prob_out = predictor(window_data, *args, **kwargs)[0]  # batched patch segmentation
