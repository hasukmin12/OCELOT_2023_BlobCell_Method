...
img_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge_for_paper/images/StainNorm/train/tissue2"
img_list = sorted(next(os.walk(img_path))[2])

aim_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge_for_paper/images/StainNorm/train/tissue_crop2"
