...
if __name__=='__main__':
    ...
    parser.add_argument('--imageDir', type=str, default='/vast/AI_team/sukmin/datasets/ocelot2023_v1.0.1/ocelot2023_v1.0.1/images/test/cell', help='RGB image file')
    parser.add_argument('--saveDir', type=str, default='/vast/AI_team/sukmin/datasets/Lunit_Challenge_for_paper/images/test/cell_n', help='save file')
    ...
    for case in input_list:
        ...
        num = int(case[:3])-1
        # output_path = join(args.saveDir, 'cell_{0:03d}.png'.format(input_list.index(case)+537)) # +400
