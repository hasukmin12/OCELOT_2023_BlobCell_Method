...
# 비교하려는 GT 폴더 결과
folder_with_gt = '/vast/AI_team/sukmin/datasets/Task701_Lunit_Cell_only/For_inference/labelsTs/'
# folder_with_gt = '/home/sukmin/datasets/Task111_Carotid_side/labelsTs'


# inference 된 결과
folder_with_pred = '/vast/AI_team/sukmin/Results_Lunit/Lunit_Only_cell_CacoX_b8_e15k'
