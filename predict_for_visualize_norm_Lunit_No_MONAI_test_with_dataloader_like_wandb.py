...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Lunit_for_paper_Cell_Only_StainNorm_r12') # 'Stroma_NDM_100x_overlap')                                                             # 2022_stomach_400x
    parser.add_argument('-i', dest='input_path', default='/vast/AI_team/sukmin/datasets/Lunit_Challenge_for_paper/images/StainNorm/test/cell') # Task701_Lunit_Cell_only/For_inference/imagesTs  
    ...
    parser.add_argument('-f_gt', dest='folder_to_inference', default='/vast/AI_team/sukmin/datasets/Lunit_Challenge_for_paper/labels/test/cell_12')
