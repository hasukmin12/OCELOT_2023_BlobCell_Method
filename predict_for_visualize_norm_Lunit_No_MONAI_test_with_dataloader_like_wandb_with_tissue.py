...
def main(info, config, args):
    ...
    # c_model_path = '/vast/AI_team/sukmin/Results_monai_Lunit_Challenge_for_paper/Cell_Only_StainNorm_BlobCell_No_MONAI/class_model_best_e15750_dice0.5218207240104675.pth'
    ...
    with torch.no_grad():
        for step, batch in enumerate(epoch_iterator_val):
            ...
            img_name = inf_loader.dataset.label_list[step]
            step += 1
            # pair_id = step + 536 # 400 536
...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', dest='aim_path', default="concat_2_15.75k") # Test_200x_CacoX_b32_e45k  
