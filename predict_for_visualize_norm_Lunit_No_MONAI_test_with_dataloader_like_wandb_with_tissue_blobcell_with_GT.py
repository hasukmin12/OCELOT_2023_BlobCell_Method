...
if __name__ == "__main__":
    ...
    parser.add_argument('-i_t', dest='input_path_tissue_GT', default='/vast/AI_team/sukmin/datasets/Lunit_Challenge_for_paper/labels/test/tissue_crop2')
    parser.add_argument('-i_b', dest='input_path_blobcell_GT', default='/vast/AI_team/sukmin/datasets/Lunit_Challenge_for_paper/labels/test/BlobCell_one_label')
    parser.add_argument('-o', dest='aim_path', default="concat_3_GT") # Test_200x_CacoX_b32_e45k  
