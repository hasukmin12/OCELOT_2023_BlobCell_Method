...
if __name__ == "__main__":
    ...
    parser.add_argument('-i_t', dest='input_path_tissue', default='/vast/AI_team/sukmin/datasets/Lunit_Challenge_for_paper/images/StainNorm/val/tissue') # Task701_Lunit_Cell_only/For_inference/imagesTs  
