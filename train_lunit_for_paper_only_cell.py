...
def main(info, config, logging=False):
    ...
    train_label_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge_for_paper/pre_augmentation/labels/train/BlobCell_one_label"
   
    val_img_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge_for_paper/pre_augmentation/images/StainNorm/val/cell"
    val_label_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge_for_paper/pre_augmentation/labels/val/BlobCell_one_label"
...
if __name__ == "__main__":
    ...
    parser.add_argument('-trainer', default= 'Lunit_for_paper_Cell_Only_StainNorm_BlobCell_one_class') # Stroma_200x_only_Epi
