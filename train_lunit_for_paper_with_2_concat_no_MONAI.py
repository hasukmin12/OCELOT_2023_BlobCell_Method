...
from core.core_for_lunit_2_concat_No_MONAI import train
...
def main(info, config, logging=False):
    ...
    train_cell_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge_for_paper/pre_augmentation/labels/train/BlobCell"
    ...
    val_cell_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge_for_paper/pre_augmentation/labels/val/BlobCell"
...
if __name__ == "__main__":
    ...
    parser.add_argument('-trainer', default= 'Lunit_for_paper_Cell_r14_2_concat') # Stroma_200x_only_Epi
